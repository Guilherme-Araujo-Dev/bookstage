...
<body>
    ...
    <a href="../../index.php"><h1 class="logo"></h1></a>
        ...
        <main>
            <h1 class="titulo">Fabulas dela fontaine</h1>
            <br><br>
            <div class="sinopse">
                <p>
                    As fábulas de Jean de La Fontaine, aqui traduzidas e adaptadas para prosa por René Ferri, so consideradas obras-primas da literatura francesa, lidas e admiradas universalmente. "No chamo graça ao que provoca o riso, mas a certa leveza, certo ar agradável que se pode atribuir a todos os assuntos, ainda os mais sérios", disse La Fontaine, que, utilizando-se de animis falantes ou pessoas hilárias, nos mostra grandes verdades sobre o comportamento humano e suas contradições. A linguagem simples, as histórias repletas de moral e as ilustrações originais de Gustavo Doré levaro adultos e crianças a uma verdadeira viagem no tempo.
                </p>
            </div>
            <div id="imagem" class="borda">
            <img src="fabulasdelafontaine.jpg">
            </div>
        </main>
        <footer class="rodape">
                <div>

...
<body>
    ...
    <a href="../../index.php"><h1 class="logo"></h1></a>
        ...
        <main>
            <h1 class="titulo">Diario de um banana</h1>
            <br><br>
            <div class="sinopse">
                <p>
                    Greg Heffley vive no inferno. Ou seja: no sexto ano do ensino fundamental. Franzino. Greg divide os corredores de sua escola com um bando de adolescentes que já se barbeiam. Para fugir destes “malvados” e conseguir um pouco de popularidade (supernecessári
        
                </p>
            </div>
            <div id="imagem" class="borda">
            <img src="diariodeumbanana.jpg">
            </div>
        </main>
        <footer class="rodape">
                <div>

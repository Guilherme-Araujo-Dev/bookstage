           ...
           <div class="formulario">
            <form action="../index.php"><br>
                <fieldset>
                    ...
                    <br>
                    <div class="input">
                        <input type="text" name="nome" id="nome" class="inputuser" required="required"  minlength="3" maxlength="100" pattern="[a-z\s]+$" />
                    ...
                    <br>
                    <input type="radio" id="outro" name="gereno" value="outro" required>
                    ...
                    <br>
                    <div class="input">
                        <input type="text" name="nomeusu" id="nomeusu" class="inputuser" required="required"  minlength="3" maxlength="50" pattern="[a-z\s]+$" />
                        <label for="nomeusu" class="label"> Nome de Usuario</label><br>
                    </div>
                    <br>
                    <br>
                    <a href="../index.php"><input type="submit" name="submit" id="submit"></a>
                </fieldset>
                </form>
    </body>
</html>';
